...
export function CreateInvoiceModal({ isOpen, onClose, entityId }: CreateInvoiceModalProps) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="New Invoice" maxWidth="max-w-4xl">
